...
const Option = ({ Icon, title, selected, setSelected, open, notifs }: { Icon: React.ComponentType<{ className?: string }>; title: string; selected: string; setSelected: (title: string) => void; open: boolean; notifs?: number }) => {
